...
def parse_args():
    ...
    parser.add_argument('--similarity_threshold', type=float, default=0.7, help='Set 0: no finetuned model. ')
    parser.add_argument('--plot_distributions', default=False, action="store_true", help='Whether to plot the distributions of predictions.')
